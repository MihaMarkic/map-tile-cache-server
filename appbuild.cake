...
var rootDirectory = Directory("./sources/Map-Tile-Cache-Server");
var solution = rootDirectory + File("Map-Tile-Cache-Server.sln");
var appDirectory = rootDirectory + Directory("Map-Tile-Cache-Server"); 
var appProject = appDirectory + File("Map-Tile-Cache-Server.csproj");
...
Task("BuildImage")
	.Does(() =>{
		...
		BuildAndPush("map-tile-cache-server", new []{ "latest", version });
	});
